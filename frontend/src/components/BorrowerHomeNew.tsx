...
export const BorrowerHome: React.FC = () => {
  ...
  const creditScoreColor = user.creditScore >= 800 ? '#00C853' : 
                          user.creditScore >= 600 ? '#FFD700' : '#FF5722';

  const creditScorePercentage = (user.creditScore / 1000) * 100;
          ...
          <div className="grid grid-cols-4 gap-3">
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                ...
                className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white py-4 rounded-2xl shadow-lg border-0 flex-col space-y-1"
              >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                ...
                className="w-full bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white py-4 rounded-2xl shadow-lg border-0 flex-col space-y-1"
              >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                ...
                className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-4 rounded-2xl shadow-lg border-0 flex-col space-y-1"
              >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                ...
                className="w-full bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white py-4 rounded-2xl shadow-lg border-0 flex-col space-y-1"
              >
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h3 className="mb-1">Credit Score</h3>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex-1">
              <div className="flex items-center justify-between mb-2">
                <span className="text-2xl" style={{ color: creditScoreColor }}>
                  {user.creditScore}
                </span>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                {user.creditScore >= 800 ? 'Excellent' : 
                 user.creditScore >= 600 ? 'Good' : 'Fair'} • 
                Upload more docs to boost your score
              </p>
            </div>
            
            <div 
              className="w-16 h-16 rounded-full flex items-center justify-center text-white text-sm"
              style={{ backgroundColor: creditScoreColor }}
            >
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <Button 
                variant="ghost" 
                size="sm"
                onClick={() => setCurrentScreen('loans-history')}
                className="text-[#007AFF]"
              >
                View All
        ...
        <div>
          ...
          {recentTransactions.length > 0 ? (
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                        transaction.type === 'receive' ? 'bg-[#00C853]/10' : 
                        transaction.type === 'pix' ? 'bg-[#FFD700]/10' :
                        'bg-[#007AFF]/10'
                      }`}>
                      ...
                      <div>
                        <p className="text-sm capitalize">
                          {transaction.type === 'pix' ? 'PIX Payment' : transaction.type}
                        </p>
            ...
            <Card className="p-8 text-center">
              ...
              <h4 className="mb-2">No transactions yet</h4>
              <p className="text-sm text-muted-foreground mb-4">
                Start by making a payment or requesting credit
              </p>
              <Button 
                onClick={() => setCurrentScreen('credit-request')}

...
const FeatureList = [
  {
    ...
    description: (
      <>
        Nossa solução P2P conecta diretamente investidores e tomadores de crédito,
        eliminando intermediários e democratizando o acesso ao financiamento para
  ...
  },
  {
    ...
    description: (
      <>
        Utilizamos <strong>Blockchain</strong> para transparência e imutabilidade das transações,
        combinado com <strong>Inteligência Artificial</strong> para avaliação de risco e
  ...
  },
  {
    ...
    description: (
      <>
        Parceria com a <strong>QI Tech</strong>, a maior fintech da América Latina,
        garantindo infraestrutura robusta, compliance regulatório e
